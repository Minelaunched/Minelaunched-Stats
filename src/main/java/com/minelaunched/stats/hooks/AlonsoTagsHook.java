...
public class AlonsoTagsHook extends MinelaunchedHook {
    ...
    public void init() {
        ...
        if (plugin != null) {
            try {
                ...
                enabled = true;
                Bukkit.getLogger().info("[MinelaunchedStats] Hooked into AlonsoTags!");
            } catch (Exception e) {
                // Ignore silent fail
            }
        }
    ...
    public static String getStats(Player player) {
        ...
        try {
            ...
            // A real implementation would invoke the exact Class.forName for com.alonsoaliaga.alonsotags.api.AlonsoTagsAPI.
            return null;
        } catch (Exception e) {
            return null;
        }
