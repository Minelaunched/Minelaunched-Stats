...
public class QuestsHook extends MinelaunchedHook {
    ...
    public void init() {
        ...
        if (plugin != null) {
            try {
                ...
                enabled = true;
                Bukkit.getLogger().info("[MinelaunchedStats] Hooked into Quests!");
            } catch (Exception e) {
                // Ignore silent fail
            }
        }
    ...
    public static int getStats(Player player) {
        ...
        try {
            ...
            // A real implementation would invoke the exact Class.forName for me.blackvein.quests.Quests.
            return 0;
        } catch (Exception e) {
            return 0;
        }
    ...
    public List<String> getExportKeys() {
        return Arrays.asList("completed_quests");
    }
