...
public class CrazyCratesHook extends MinelaunchedHook {
    ...
    public void init() {
        ...
        if (plugin != null) {
            try {
                ...
                enabled = true;
                Bukkit.getLogger().info("[MinelaunchedStats] Hooked into CrazyCrates!");
            } catch (Exception e) {
                // Ignore silent fail
            }
        }
    ...
    public static int getStats(Player player) {
        ...
        try {
            ...
            // A real implementation would invoke the exact Class.forName for me.badbones69.crazycrates.api.CrazyCrates.
            return 0;
        } catch (Exception e) {
            return 0;
        }
