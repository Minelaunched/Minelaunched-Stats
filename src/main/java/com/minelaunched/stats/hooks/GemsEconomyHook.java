...
public class GemsEconomyHook extends MinelaunchedHook {
    ...
    public static double getStats(Player player) {
        ...
        try {
            ...
            // A real implementation would invoke the exact Class.forName for me.xanium.gemseconomy.api.GemsEconomyAPI.
            return 0;
        } catch (Exception e) {
            return 0;
        }
